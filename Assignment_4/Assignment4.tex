...
A              & 5th toss is a head                   \\ \hline
B              & Exactly 2 heads in first four tosses \\ \hline
C              & 5th toss is the third head           \\ \hline
\end{tabular}
...
\pr{B}&=\dfrac{{}^{4}C_{2}}{2^4}=\dfrac{3}{8}
\end{align}
