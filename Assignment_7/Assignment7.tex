...
\begin{align}
    ...
    &=\sum_{y=\frac{1}{4}}^{\frac{3}{4}} P_{Y}(y)\pr{\frac{1}{4}+y<X,\frac{1}{4}<X<\frac{3}{4}}\\
     &=\int_{y=\frac{1}{4}}^{\frac{3}{4}}dyf_Y(y)\pr{\frac{1}{4}+y<X<\frac{3}{4}}\label{step2}
     \end{align}
     ...
     \begin{align}
    \pr{ABC}&=\int_{y=\frac{1}{4}}^{\frac{1}{2}}dyf_Y(y)\brak{\frac{1}{2}-y}
    \end{align}
